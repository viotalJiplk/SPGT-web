...
CREATE TABLE `d215865_spgtweb`.`zapisy` ( `id` INT NOT NULL AUTO_INCREMENT , `time` DATE NOT NULL , `program` TEXT NOT NULL , `zapis` TEXT NOT NULL , `materialy` TEXT NULL , `hlasovani` INT NULL , PRIMARY KEY (`id`));